export default function Tooltip({ children, text, placement = "top" }) {
  ...
  return (
    <div className="relative group">
      {children}
      <div
        className={`${containerClasses} px-3 py-1.5 bg-slate-800 text-white text-xs font-medium rounded-lg whitespace-nowrap opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 ease-in-out z-50 pointer-events-none shadow-lg`}
      >
        {text}
