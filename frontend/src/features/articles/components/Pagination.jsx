...
const NAV_BTN =
  "inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-sm font-medium transition-colors duration-150 ease-out focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-moss-600 focus-visible:ring-0 disabled:text-slate-500 disabled:cursor-not-allowed";
